...
<table>
  ...
  <tr><td colspan="2"><b>String manipulation</b></td></tr>
    ...
    <tr><td>matchlist()     </td><td>like matchstr() and also return submatches</td></tr>
  ...
  <tr><td colspan="2"><b>List manipulation</b></td></tr>
    ...
    <tr><td>range()    </td><td>return a List with a sequence of numbers</td></tr>
  ...
  <tr><td colspan="2"><b>System functions and manipulation of files</b></td></tr>
    ...
    <tr><td><a href="../../../blob/master/functions/executable.vim">executable()</a>   </td><td>check if an executable program exists</td></tr>
    ...
    <tr><td>system()       </td><td>get the result of a shell command</td></tr>
